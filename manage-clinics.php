...
<body>
    <div class="wraper d-flex">
        ...
        <div class="main-content">
            ...
            <div class="col-md-11 col-sm-11 col-11 m-auto">
                <div class="manage-page">
                    <h2 class="mb-4">Manage Clinics Records</h2>
                    <div class="table-responsive">
                        <table id="manage-clinics-table" class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Address</th>
        ...
        <!-- Edit Modal Start -->
                <div class="modal fade" id="edit-clinic-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-color">
                                <h5 class="modal-title" id="exampleModalLabel">Edit Clinics</h5>
                            ...
                            <div class="modal-body border-0">
                                <form>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label cust-labl">Clinic Name :</label>
                            ...
                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn btn-save" onclick="updateClinic()">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="assets/js/clinics.js"></script>
